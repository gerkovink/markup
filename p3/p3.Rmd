---
title: "Practical 3: `git` and GitHub"
...
See also: RDM support book [Best Practices for Writing Reproducible Code](https://utrechtuniversity.github.io/workshop-computational-reproducibility/) and info page [GitHub and Git for research and teaching](https://www.uu.nl/en/research/research-data-management/tools-services/software-and-computing/github-and-git).
...
This week we will learn how to use $git$ properly when we mess up. But let's not learn that on this year's repo ;-). Fork the last year's repository [here](https://github.com/gerkovink/markup2020), deselect! `Copy the master branch only` in order to copy all branches and checkout the `Exercise_wk4` branch.
