...
\usepackage[]{hyperref}
\hypersetup{
    pdftitle={Letter with 12pt font on A5 paper},
...
\begin{document}
% Make title does not work in Letter class (there is no document title or titlepage
%\maketitle

% Section does not work in Letter class
