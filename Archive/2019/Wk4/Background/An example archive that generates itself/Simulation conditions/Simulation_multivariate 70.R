...
#run simulation
SIM <- simulate.multivariate(population, nsim=nsim, m=5, mis.p=.7)
...
out70 <- rbind(finite1, rubin1, finite2, rubin2)
...
out70BR <- rbind(finite1BR, rubin1BR, finite2BR, rubin2BR)


save.image("Workspaces/Multivariate_sim70.RData")