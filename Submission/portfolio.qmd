...
This course is graded by means of a portfolio. Students collect evidence of their ability to:

1. Use markup languages for scientific manuscript writing
2. Produce a reproducible repository that conforms to rigorous open science and computing standards
3. Present this portfolio using markup languages
4. Develop, test, maintain and host this portfolio.
